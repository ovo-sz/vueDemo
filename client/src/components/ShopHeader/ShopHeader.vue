<template>
  <div class="shop-header">
    <nav class="shop-nav" :style="{ backgroundImage: `url(${info.bgImg})` }">
      <router-link replace to="/home" class="back">
        <i class="iconfont iconjiantou1" />
      </router-link>
    </nav>
    <div class="shop-content">
      <img v-lazy="info.avatar" class="content-image" />
      <div class="header-content" @click="isShowBullitin = true">
      ...
      <div class="activity-sheet" v-show="isShowSupports">
        <div class="activity-sheet-content">
          ...
          <div class="activity-sheet-close">
            <span class="iconfont iconX" @click="isShowSupports = false"></span>
          </div>
        </div>
